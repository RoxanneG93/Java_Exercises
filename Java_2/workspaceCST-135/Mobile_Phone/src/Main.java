...
public class Main {
	...
	private static MobilePhone mobilePhone = new MobilePhone("0039 330 4404", null);
...
//		creating new contact object with what the user inputs
...
//	Menu method
	private static void printActions() {
		...
		System.out.println( "0 - to shutdown\n" + 
							...
							"4 - to remove existing contac\nt" +
							"5 - query if an existing contact exists\n" +
							"6 - to print a lst of available actions."
